/*
 * @(#)DefaultListModel.java	1.26 00/02/02
 * 
 ...
 * @author Hans Muller
 */
public class BetterListModel extends AbstractListModel{
    ...
    public void addAll(int index, Collection c){
        ...
        for(Iterator i = c.iterator(); i.hasNext(); ){
            Object o = i.next();
            delegate.insertElementAt(o, ix);
            ix++;
        }
        fireIntervalAdded(this, index, ix - 1);
    }
